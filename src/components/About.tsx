        ...
        <div className="about_us_cards_container">
          <div className="about_us_card">
            ...
            <p className="about_us_card_description">
              ...
              socializing with the horse, which can be a rewarding experience.
            </p>
          </div>
          <div className="about_us_card">
            ...
            <p className="about_us_card_description">
              ...
              nutrition, and other forms of horsemanship.
            </p>
          </div>
          <div className="about_us_card">
            ...
            <p className="about_us_card_description">
              ...
              a great way to meet people and develop new skills.
            </p>
          </div>
        </div>
