      ...
      <ul className="faq_content_container">
        <li className="faq_question_container">
          ...
          <p className="faq_answer general_text faq_answer_inactive">
            No! The service provided is a one time fee, however there is a
            general maintenance fee to keep the created website online. This fee
            is charged by the host to run the servers.
          </p>
        </li>
        <li className="faq_question_container">
          <button
          ...
          <p className="faq_answer general_text faq_answer_inactive">
            Of course! All slides are fully customizable to your specifications.
            You will work directly with one of our designers to help fulfill
            your requirements.
          </p>
        </li>
        <li className="faq_question_container">
          ...
          <p className="faq_answer general_text faq_answer_inactive">
            Please provide all relevant files such as pictures, coach
            descriptions, contact info, etc..
          </p>
        </li>
        <li className="faq_question_container">
          <button
